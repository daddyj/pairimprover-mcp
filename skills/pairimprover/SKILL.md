...
**After every reply where you wrote or changed code:** Call `check_session_quality` with two fields: `userMessage` (the user's last message — quote their key phrases) and `implementation` (what you built or changed). Do this before or at the start of your next reply.
